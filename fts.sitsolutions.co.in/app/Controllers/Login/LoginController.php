    ...
    public function signIn()
    {
        ...
        if($this->validate($rules))
        {
           ...
           if(!empty($result))
           {
                ...
                $marathiDistname  = $result1['marathi_name'];
                $englishDistname  = $result1['english_name'];
                session()->set('id',$id);
                ...
                $this->session->set('marathi_name',$marathiDistname);
                $this->session->set('english_name',$englishDistname);
