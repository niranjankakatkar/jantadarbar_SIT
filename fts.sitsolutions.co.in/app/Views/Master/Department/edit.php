                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 fw-semibold m-0">शाखा</h4>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                     ...
                                     <div class="card-body">
                                        <div class="row g-3">
                                        <div class="col-md-12">
                                            <?php echo form_open('/Admin-store_dept', array('autocomplete' => 'off','class' => 'p-0 myForm')); ?>
                                                    ...
                                                    <div class="mb-2 col-md-6">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control" placeholder="कृपया शाखेचे नाव प्रविष्ट करा" value="<?= $list['name'] ?? set_value('name'); ?>">
                                                    ...
                                                    <div class="mb-2 col-md-6">
                                                       ...
                                                       <?php $vibhag = set_value('direction'); ?>
                                                        <select id="direction" name="direction" class="form-control">
                                                            <option value="">दिशा निवडा</option>
                                                            <option value="1" <?php if($vibhag || $list['direction']==1){echo 'selected';} ?>>दक्षिण</option>
                                                            <option value="2" <?php if($vibhag || $list['direction']==2){echo 'selected';} ?>>उत्तर</option>
                                                        </select>
                                                        <?php  if(isset($validation)) {?>
                                                            <div class="text-danger" style="text-align: left;margin-left: 5px;color: #ec536c!important;">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel">शाखा</h4>
                       </div>
