                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 fw-semibold m-0">आधिकारी</h4>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                     ...
                                     <div class="card-body">
                                        <div class="row g-3">
                                        <div class="col-md-12">
                                            <?php echo form_open('/store_desig', array('autocomplete' => 'off','class' => 'p-0 myForm')); ?>
                                                    <input type="hidden" name="id" value="<?= !empty($list['id']) ? $list['id'] : '' ?>">
                                                    <div class="mb-2 col-md-6">
                                                        <label for="name" class="form-label">आधिकार्याचे नाव<span class="text-danger">*</span></label>
                                                        <input type="text" id="name" name="name" class="form-control" placeholder="कृपया आधिकार्याचे नाव प्रविष्ट करा" value="<?= $list['name'] ?? set_value('name'); ?>">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel">आधिकार्याचे नाव</h4>
                       </div>
