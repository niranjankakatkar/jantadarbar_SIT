...
<!-- Mirrored from kanakku.dreamstechnologies.com/html/template/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Feb 2025 11:21:32 GMT -->
<head>
		<meta charset="utf-8">
		...
		<!-- Layout Js -->
		<script src="<?=base_url();?>public/assets/js/layout.js" type="8e8532ea8f5c6a5be19f4c72-text/javascript"></script>
	</head>
	<body>
		...
		<div class="main-wrapper login-body">
			<div class="login-wrapper">
				<div class="container">
					...
					<img class="img-fluid logo-dark mb-2 logo-color" src="<?=base_url();?>public/assets/img/logo2.png" alt="Logo">
					<img class="img-fluid logo-light mb-2" src="<?=base_url();?>public/assets/img/logo2-white.png" alt="Logo">
					<div class="loginbox">
		...
		<div class="settings-icon d-none"> 
			<span data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas"><img src="<?=base_url();?>public/assets/img/icons/siderbar-icon2.svg" class="feather-five" alt="layout"></span> 
		</div> 
		<div class="offcanvas offcanvas-end border-0 " tabindex="-1" id="theme-settings-offcanvas"> 
			<div class="sidebar-headerset">
				...
				<div class="sidebar-headerclose">
					<a data-bs-dismiss="offcanvas" aria-label="Close"><img src="<?=base_url();?>public/assets/img/close.png" alt="img"></a>
				</div>
			</div>
							...
							<div class="col-4"> 
								<div class="form-check card-radio p-0"> 
									...
									<label class="form-check-label avatar-md w-100" for="customizer-layout01"> 
										<img src="<?=base_url();?>public/assets/img/vertical.png" alt="img">
									</label> 
								</div> 
							...
							<div class="col-4"> 
								...
								<input id="customizer-layout02" name="data-layout" type="radio" value="horizontal" class="form-check-input"> 
									<label class="form-check-label  avatar-md w-100" for="customizer-layout02"> 
										<img src="<?=base_url();?>public/assets/img/horizontal.png" alt="img">
									</label> 
								</div> 
							...
							<div class="col-4 d-none"> 
								<div class="form-check card-radio p-0"> 
									...
									<label class="form-check-label  avatar-md w-100" for="customizer-layout03"> 
										<img src="<?=base_url();?>public/assets/img/two-col.png" alt="img">
									</label> 
								</div> 
								...
								<div class="col-4"> 
									<div class="form-check card-radio p-0 "> 
										...
										<label class="form-check-label avatar-md w-100 px-2" for="layout-width-boxed"> 
											<img src="<?=base_url();?>public/assets/img/boxed.png" alt="img"> 
										</label> 
									</div> 
							...
							<div class="col-4"> 
								<div class="form-check card-radio p-0"> 
									...
									<label class="form-check-label  avatar-md w-100" for="topbar-color-dark"> 
										<img src="<?=base_url();?>public/assets/img/dark.png" alt="img">
									</label> 
								</div> 
								...
								<div class="col-4 d-none"> 
									<div class="form-check sidebar-setting card-radio p-0"> 
										...
										<label class="form-check-label  avatar-md w-100" for="sidebar-size-compact"> 
											<img src="<?=base_url();?>public/assets/img/compact.png" alt="img">
										</label> 
									</div> 
								...
								<div class="col-4" > 
									<div class="form-check sidebar-setting card-radio p-0 "> 
										...
										<label class="form-check-label avatar-md w-100" for="sidebar-size-small-hover"> 
											<img src="<?=base_url();?>public/assets/img/small-hover.png" alt="img">
										</label> 
									</div> 
								...
								<div class="col-4"> 
									<div class="form-check sidebar-setting card-radio p-0"> 
										...
										<label class="form-check-label  avatar-md w-100" for="sidebar-view-detached"> 
											<img src="<?=base_url();?>public/assets/img/detached.png" alt="img">
										</label> 
									</div> 
		...
		<!-- /Theme Setting -->		
		<!-- jQuery -->
		<script src="<?=base_url();?>public/assets/js/jquery-3.7.1.min.js" type="8e8532ea8f5c6a5be19f4c72-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="<?=base_url();?>public/assets/js/bootstrap.bundle.min.js" type="8e8532ea8f5c6a5be19f4c72-text/javascript"></script>

		<!-- Theme Settings JS -->
		<script src="<?=base_url();?>public/assets/js/theme-settings.js" type="8e8532ea8f5c6a5be19f4c72-text/javascript"></script>
		<script src="<?=base_url();?>public/assets/js/greedynav.js" type="8e8532ea8f5c6a5be19f4c72-text/javascript"></script>
		
		<!-- Custom JS -->
		<script src="<?=base_url();?>public/assets/js/script.js" type="8e8532ea8f5c6a5be19f4c72-text/javascript"></script>

	<script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="8e8532ea8f5c6a5be19f4c72-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"90eb3b3a89573a48","version":"2025.1.0","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from kanakku.dreamstechnologies.com/html/template/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Feb 2025 11:21:33 GMT -->
</html>