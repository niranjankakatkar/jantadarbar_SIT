...
<head>
        ...
        <meta charset="utf-8" />
        <title>FTS - नकार कारण यादी </title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1 d-flex justify-content-between">
                                <h4 class="fs-18 fw-semibold m-0">नकार कारण यादी </h4>
                                <a href="<?= base_url();?>AddRejectReason">
                                    <button type="button" class="btn btn-success">+ नवीन नकार कारण </button>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">नकार कारण यादी </h5>
                                    </div><!-- end card header -->
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=$row['reason'];?></td>
                                                    <td>  
                                                    <a href="<?php echo base_url(); ?>updateRejectionReason?ID=<?php echo base64_encode($row['id']); ?>" >
...
<script>
        ...
        {
            var table='tbl_rejection_reason';
