                                        ...
                                        <div class="col-md-12">
                                            <?php echo form_open('/store_rejection_reason', array('autocomplete' => 'off','class' => 'p-0 myForm')); ?>
                                                    <div class="mb-2 col-md-6">
                                                        <label for="name" class="form-label">नकाराचे कारण<span class="text-danger">*</span></label>
                                                        <input type="text" id="reason" name="reason" class="form-control" placeholder="कृपया नकाराचे कारण प्रविष्ट करा" value="<?= set_value('reason'); ?>">
