                                        ...
                                        <div class="col-md-12">
                                            <?php echo form_open('/store_dept', array('autocomplete' => 'off','class' => 'p-0 myForm')); ?>
                                                    <div class="mb-2 col-md-6">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control" placeholder="कृपया शाखेचे नाव प्रविष्ट करा" value="<?= set_value('name'); ?>">
                                                    ...
                                                    <div class="mb-2 col-md-6">
                                                       ...
                                                       <?php $vibhag = set_value('direction'); ?>
                                                        <select id="direction" name="direction" class="form-control">
                                                            ...
                                                            <option value="1" <?php if($vibhag ==1){echo 'selected';} ?>>दक्षिण</option>
                                                            <option value="2" <?php if($vibhag ==2){echo 'selected';} ?>>उत्तर</option>
                                                        </select>
                                                        <?php  if(isset($validation)) {?>
                                                            <div class="text-danger" style="text-align: left;margin-left: 5px;color: #ec536c!important;">
