...
<head>
	...
	<meta charset="utf-8" />
	<title>Savvy - Edit Products </title>
								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-6 col-sm-12">
										<div class="input-block mb-3">
											...
											<input type="text" name="product_name"  class="form-control" placeholder="Enter Product Name"  value="<?= $list['product_name'] ?? set_value('product_name'); ?>">
									...
									<div class="col-lg-4 col-md-6 col-sm-12">
										<div class="input-block mb-3 add-products">
											...
											<input type="text" name="product_code" class="form-control" placeholder="Enter Product Code" value="<?= $list['product_code'] ?? set_value('product_code'); ?>">
									...
									<div class="col-lg-4 col-md-6 col-sm-12">
										<div class="input-block mb-3">
											...
											<input type="text" name="selling_price" class="form-control" placeholder="Enter Selling Price" value="<?= $list['selling_price'] ?? set_value('selling_price'); ?>">
											<?php if (isset($validation)) { ?>
												<div class="text-danger"
													style="text-align: left;margin-left: 5px;color: #ec536c!important;">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-12 description-box">
										<div class="input-block mb-3" id="summernote_container">
											...
											<textarea name="description" class="summernote form-control"
												placeholder="Type your message"><?= $list['description'] ?? set_value('description'); ?></textarea>
												<?php if (isset($validation)) { ?>
												<div class="text-danger"
													style="text-align: left;margin-left: 5px;color: #ec536c!important;">
