												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a ><?=$row['product_name'];?> <span><span class="__cf_email__" ><?=$row['product_code'];?></span></span></a>
														</h2>
													</td>
													<td><?=$row['product_code'];?></td>
													<td><?=$row['selling_price'];?></td>													
													<td><img class="avatar-img sales-rep" style="height:50px;width:50px" src="uploads/<?=$row['image'];?>" alt="User Image"></td>
													<td class="d-flex align-items-center">
														...
														<div class="dropdown dropdown-action">
															...
															<div class="dropdown-menu dropdown-menu-end">
																<ul>
																	<li>
																		<a class="dropdown-item" href="<?php echo base_url(); ?>Admin-updateProducts?ID=<?php echo base64_encode($row['id']); ?>" ><i class="far fa-edit me-2"></i>Edit</a>
																	</li>
																	<li>
