...
class MasterController extends BaseController
{
    ...
    /************ Vendor Master - Niranjan Kakatkar ****************/
 ...
 /************ Products Master - Niranjan Kakatkar ****************/
    ...
    public function Products()
    {
        ...
        $data['all_list'] = $this->MasterModel->getAllData('tbl_products');
       
        return view('AdminMaster/Products/view',$data);
    }
    public function AddProducts()
    {
        return view('AdminMaster/Products/add');
    }
    public function store_Products()
    {
            ...
            if($_FILES['image']['name']!='')
        {
            ...
            $upload_path="uploads/";
            $Reg_Certificate = $documents.".".$extension;
            $file_size =$_FILES['image']['size'];
            $file_tmp =$_FILES['image']['tmp_name'];
            $file_type=$_FILES['image']['type'];
            $file_ext=strtolower(end(explode('.',$filename))); 
            $reg = move_uploaded_file($file_tmp,$upload_path.$Reg_Certificate);
        }
            ...
            $data = [
                ...
                'image' => $Reg_Certificate
            ];

          
            $deptData = $_POST;
            $builder = $db->table('tbl_products');
            ...
            {
                $builder->where('id', $editId)->update($data);
            }
        ...
        }else
        {
            ...
            if(empty($editId))
            {
                return view('AdminMaster/Products/add', ['validation' => $validation]);
            }else {
                $list = $this->MasterModel->getData('tbl_products',$editId);
                return view('AdminMaster/Products/edit', ['validation' => $validation,'list' => $list]);
            }
        }
    }
    ...
    {
        $id = base64_decode($_GET['ID']);
        $data['list'] = $this->MasterModel->getData('tbl_products',$id);
        return view('AdminMaster/Products/edit',$data);
    }
